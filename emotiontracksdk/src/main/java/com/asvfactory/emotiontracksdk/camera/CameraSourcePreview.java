 ...
 */
package com.asvfactory.emotiontracksdk.camera;
...
//        mTextureView.setSurfaceTextureListener(this);
    ...
    /*  @Override
      public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
          ...
          try {
              startIfReady();
             // mCameraSource.s.setPreviewTexture(surface);
          } catch (IOException e) {
  ...
  //                previewSize.getWidth(), previewSize.getHeight(), Gravity.CENTER));
  //
  //        try{
  //          //  mCameraSource.start(mTextureView).setPreviewTexture(surface);
  //        } catch (IOException t) {}
  //
